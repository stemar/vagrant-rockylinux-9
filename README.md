# Vagrant box Rocky Linux 9 LAMP

Make a Vagrant box with Rocky Linux 9 LAMP stack, plus configure it for development.

- Host: Linux or Mac.
- Guest: Rocky Linux 9, Apache 2.4, MariaDB 10.6, PHP 8.2, Python 3.9, Ruby 3.0, Git 2.x.
...
```bash
mkdir -p ~/VM && cd $_
git clone --depth=1 https://github.com/stemar/vagrant-rockylinux-9.git rockylinux-9
cd ~/VM/rockylinux-9
...
- 64bit Rocky Linux 9 virtual machine with virtual 64GB HDD, 3GB RAM and updated LAMP stack from [Bento](https://app.vagrantup.com/bento/boxes/rockylinux-9).
